...
export default async function ProfilePage() {
  return (
    <section className='flex min-h-[calc(100vh-150px)] flex-col items-center justify-between gap-y-6 sm:min-h-[calc(100vh-142px)]'>
      ...
      <div className='flex flex-col sm:gap-4 sm:py-4 sm:pl-14'>
        <header className='sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6'>
            ...
            <SheetContent side='left' className='sm:max-w-xs'>
              <nav className='grid gap-6 text-lg font-medium'>
                <Link
                  ...
                  <Logo className='size-5 transition-all group-hover:scale-110' />
          ...
          <div className='relative ml-auto flex-1 md:grow-0'>
            <Logo className='absolute left-2.5 top-2.5 size-4 text-muted-foreground' />
            <Input
              type='search'
              placeholder='Search...'
