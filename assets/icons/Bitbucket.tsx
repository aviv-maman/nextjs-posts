...
const Bitbucket: React.FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg aria-label='bitbucket' height='20' viewBox='-2 -2 65 59' width='20' {...props}>
      <defs>
        <linearGradient id='bitbucket-:r8:' x1='104.953%' x2='46.569%' y1='21.921%' y2='75.234%'>
      ...
      <path
        ...
        fill='url(#bitbucket-:r8:)'
        fillRule='nonzero'
        transform='translate(-.026 .82)'></path>
      <path
